...
<script type="text/javascript">
	   ...
	   function AddToCart(camp,billcode,billdesc,qty) {
		  HttPRequest = false;
		  if (window.XMLHttpRequest) { // Mozilla, Safari,...
			 HttPRequest = new XMLHttpRequest();
			 if (HttPRequest.overrideMimeType) {
		  ...
		  if (!HttPRequest) {
			...
			var pmeters = 'camp='+ camp +'&billcode='+billcode+'&qty='+qty;
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    <td height="359" align="center" valign="top" class="Sheet_Boder" style="padding:2px"><!-- Start  Content  -->    
        
    <table width="900" border="0" cellspacing="0" cellpadding="3">
      <tr>
        <td align="left"><iframe src="<?  echo $page_url ?>" width="99%" height="300" frameborder="0" class="FormBorderGray"  >
	</iframe></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
?>          <select name="sel_page2" id="sel_page3" onchange="preview_data('<? echo $brand ?>','<? echo $type ?>', <? echo $camp ?>);">
 ...
 <iframe src="<?  echo "booklet_Cover.php"; ?>" width="99%" height="800" frameborder="0" class="FormBorderGray"  >
	</iframe></td>
      </tr>
      <tr>
        <td width="904" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
              <td width="39%"><a name="data" id="data"></a>รายการผลิตภัณฑ์<? echo $str_brand?> หน้าที่
                <?PHP 
...
<select name="sel_page" id="sel_page" onchange="preview_data('<? echo $brand ?>','<? echo $type ?>', <? echo $camp ?>);">
  <option>เลือกหน้าแคตตาล็อค</option>
	...
	<p><a href="#data" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-newwin"></span>Open Dialog</a></p>
