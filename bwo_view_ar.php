...
<?php 
			...
			//2 - 8	
				...
				$C = $aInfo[8];
				$E = $aInfo[11];
				//$award = number_format($aInfo[12],0,".",",");
				//$ar_bal = number_format($aInfo[12],2,".",",");
				$ar_bal = number_format($aInfo[12],2,".",",");
				$paydate = $aInfo[13];
			//9 - 23
				$BPRBalfwd = number_format($aInfo[14],0,".",",");
				$BPRBal = number_format($aInfo[15],0,".",",");
				$BPRAdj = number_format($aInfo[16],0,".",",");
				$BPRUse = number_format($aInfo[17],0,".",",");
				$BPR_Current = $aInfo[5]- $aInfo[14];
				//$BPRBalfwd-$BPRUse = number_format($aInfo[13],2,".",",");
				$BPRExpire = number_format($aInfo[19],0,".",",");
				$rep_member = $aInfo[20];
				$add_line1 = $aInfo[21];
				$add_line2 = $aInfo[22];
				$add_line3 = $aInfo[23];
						  ...
						  <tr>
							<td width="700" colspan="2" align="center">
							  ...
							  <tr>
								...
								<strong>คะแนนสะสม ของสมาชิกที่มีอยู่ตอนนี้ คือ :</strong>
							  ...
							  <tr bgcolor=#FFCCFF align=center>
								<td width="479" colspan="2" align="left">
								<p><strong>เงินออมทรัพย์จากมิสทินปีที่ <? echo $A;?> เริ่มรอบที่  <?php echo $B;?> </strong> </p>
								<strong>เงินออมทรัพย์สะสมรวม  :  </strong>
								<strong><font color="#FF0000"><?php echo $E; ?> </font> บาท </strong>
								</td>
							  </tr>
							  <?php
							  }
