...
function test_sendmail ($campaign, $dist, $mslno, $chkdgt, $rep_name, $email, $amount, $strcurrentdate, $strcurrenttime) {
		...
		$msg_header.= "เรียนทุกท่านเพื่อทราบ mail MAIL SRV  TEST <br />";
		...
		$mail_user = 'bworder-01@mistine.co.th';
		$mail_pass = 'sd1234';
		$mail_to   = 'dsmorder2016@gmail.com;perapong.sitti@gmail.com'; // notify=success,failure';     //$_GET['mailto'];
		//$mail_to   = 'chaitaporn.su@gmail.com'; // notify=success,failure';     //$_GET['mailto'];
