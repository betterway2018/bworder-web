        ...
        <tr>
          <td width="719" valign="top"><fieldset style="margin-top:12px;height:400px">
            <table width="666"  border="0" align="center" cellpadding="3" cellspacing="1">
              <tr>
                <td colspan="2" ><strong class="content_header3">ลงทะเบียนเพื่อสั่งซื้อสินค้าผ่านอินเตอร์เน็ต</strong>
                </td>
                </tr>
              <tr>
                <td  align="right">&nbsp;</td>
              ...
              <tr>
                <td width="158"  align="right">รหัสสมาชิก :</td>
...
*
              ...
              <tr>
                ...
                <td><input name="txtemail" type="text" id="txtemail" size="32" />
                  * กรุณาระบุ e-mail ของคุณ</td>
              </tr>
              <tr>
                <td align="right">&nbsp;</td>
                <td><strong><font color="#FF0033">ท่านจะไม่ได้รับ e-mail ยืนยันการสั่งซื้อสินค้าและคำถามของท่านจะไม่ได้ <br />
                  รับการตอบกลับ ถ้าท่านไม่ได้ให้ข้อมูล   e-mail ไว้</font></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right">พิมพ์รหัสผ่าน  :</td>
              ...
              <tr>
                ...
                <td><input name="txtpwd2" type="password" id="txtpwd2" size="36" maxlength="12" />
                  <font color="#444444">* ยืนยันรหัสผ่านที่คุณได้กำหนดแล้ว</font></td>
              </tr>
              <tr>
                <td align="right"></td>
                <td>
<input name="Button" type="button"  id="Submit" value="บันทึกข้อมูล" class="formbutton"   onclick="return form_submit();"/>&nbsp;<input name="Reset" type="reset"  id="button" value="ล้างข้อมูล" class="formbutton"/></td>
              </tr>
              <tr>
                <td align="right">&nbsp;</td>
                <td>&nbsp;</td>
									       ...
									       //   alert('ERROR2___'+rep_name);
											...
											{  // หาไม่เจอ
                                                     //      alert('ERROR3rep_name==""___'+rep_name);
														//alert(err_desc);
														//document.getElementById('div_wait').innerHTML = "";
													      alert("เกิดข้อผิดพลาด:  ไม่พบข้อมูลสมาชิกค่ะ ...");
														  	document.getElementById('div_wait').innerHTML=  ' '; 
														return false;
											}
