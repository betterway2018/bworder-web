...
//####################################################################################	
			...
			if ($totalRows_order >0 ) {
					...
					do {
							...
							array_push($arr_brand,$row_order_detail['BRAND']);
...
<?php if ($flag=="UPDATE") {?>                    
                      <input type="button" name="but_Del2" id="but_Del2" value="ลบรายการสั่งซื้อทั้งหมด"  onclick="javascript:confirmDelete('order_delete.php?<? echo $script_link; ?>','<? echo $strcamp ."-".$strpo?>');" class="formbutton"/>
<?php } ?>                         
