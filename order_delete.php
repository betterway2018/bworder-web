...
//$query_order = "DELETE FROM order_header WHERE dist='$dist' and mslno=$mslno and chkdgt=$chkdgt and order_no=$po";

$query_order = "UPDATE   order_header set DELFLAG='Y'  WHERE dist='$dist' and mslno='$mslno' and chkdgt='$chkdgt' and order_no='$po' and ordcamp='$camp' and DELFLAG='N'";
...
$query_order_line = "UPDATE order_detail  SET DELFLAG='Y'  WHERE dist='$dist' and mslno='$mslno' and chkdgt='$chkdgt' and order_no='$po' and ordcamp='$camp'";
