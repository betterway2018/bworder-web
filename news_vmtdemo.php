...
$query="Select * From content_data  Where group_id=5  and status = 0 Order by  id desc";
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <td align="center" valign="top" bgcolor="#FFFFFF" style="padding:3px;height:300px"><table width="783" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="17%"><img src="table_smooth/demo_mistine.png" width="300" height="78" /></td>
  ...
  <br />
    ...
    <table width="872" border="0" cellspacing="0" cellpadding="4">
      <tr>
        <td colspan="2" align="left">&nbsp;ใบปลิวหน้าอื่น จาก มิสทิน</td>
        </tr>
      <tr>
...
<?php 
	...
	do {
?>        
         <li><a href="news_vmtdemo.php?id=<?php echo $row_content_data['ID'];?>" target="_parent"><?php echo $row_content_data['SUBJECT'];?></a></li> 
<?php 
	$i++;
