...
<%
    ...
    Dim postUrl
		...
		DataToSend="p_OuCode=000&p_SessionID=" & SessionID & "&p_LocCode=" & dist & "&p_RepCode=" & dist & right("00000" & mslno,5) & chkdgt & "&p_BillCamp=" & BillCampSend & "&p_BillCode=" & BillCode & "&p_BillName= " & BillName & "&p_OrdUnit=" & OrdQty  & "&p_BookQty=" & OrdUnit &  "&p_ProgID=" & ProgID & "&p_OrdType=" & OrdType & ""
		postUrl = "http://10.0.0.57/VSWebservice_Test/VRStock.asmx/genBillReverseBooking" & "?" & DataToSend
