...
if( $_SERVER['REQUEST_METHOD']=="POST" )
{
	...
	///////////////////  GET Paramete  MSLMST_ETL//////////////////////////////////////
				 ...
				 $query_= " SELECT
							mslmst.rep_seq,
							mslmst.GOLDCLUB,mslmst.REP_STATUS as STATUS
							FROM
			...
			//echo    $query_;	 exit;
                     ...
                     $GOLDCLUB = $row_mslmst_01['GOLDCLUB'];
					 $status = $row_mslmst_01['STATUS'];
					  if($status == 'NM')
						{

						$status = 'Inactive';
						$sqlGOLDCLUB=" UPDATE MSLMST SET GOLDCLUB  = '$GOLDCLUB',STATUS  = '$status'  WHERE   rep_seq=$rep_seq ";  
