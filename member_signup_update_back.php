...
//		echo "<meta http-equiv='refresh' content='0;URL=login.php'>";
	...
	$query = "INSERT INTO MSLMST 	(DIST,MSLNO,CHKDGT,NAME,PWD,EMAIL,PHONE,BIRTHDATE,STATUS,
								  ARBALANCE,BPRBALANCE,QUESTION,ANSWER,REG_DATE,REG_TIME,LAST_UPDATE,rep_seq) 			  VALUES('$dist',$mslno,$chkdgt,'$rep_name','$pwd1','$email','$phone',$birthdate,'Active',0,0,'$question','$answer',$reg_date,'$reg_time',$reg_date,$rep_seq)";
