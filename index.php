  ...
  <tr>
    <td height="480" align="left" valign="top" class="Sheet_Boder" style="padding:2px"><br />
      ...
      <table width="0" border="0"   cellspacing="5">
        <tr>
          <td align="center"><a href="order_check.php?rep_seq=<?php echo $rep_seq; ?>" target="_parent" onmouseover="MM_swapImage('Image1','','images/New_Button/A02.gif',1)" onmouseout="MM_swapImgRestore()"><img src="images/New_Button/A01.gif" alt="สั่งซื้อสินค้าด่วน" name="Image1" width="144" height="119" border="0" id="Image1" /></a>
		  <input name="CurCamp " type="hidden" value="<?php echo $CurCamp; ?>" />		  </td>
...
<div id="dialogpointYUPIN" title="ข่าวดีสำหรับ คุณ <?php echo $name?>">
 ...
 <table id="Table_01" width="687" height="150" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td>
			<!--<img src="images/banner_popup/BW-Order-Key-order C.6-2018.jpg" width="680" height="400" > -->
			<img src="images/banner_popup/BW Order C.7-2018.jpg" width="680" height="400" >
		</td>
	</tr>
</table>
<!--
