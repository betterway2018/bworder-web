        ...
        <tr>
          ...
          <td valign="top" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="1" cellpadding="2">
            <tr>
              ...
              <td width="43%"><? printf("%s-%s-%s ",$_SESSION['dist'],$_SESSION['mslno'],$_SESSION['chkdgt']); ?>
           </td>
...
?>     
          <tr  bgcolor="<? echo $bg; ?>">
            ...
            <td valign="top"><li><a href="javascript: MM_openBrWindow('order_view.php?<? echo $script_link;?>','', 790, 550,'yes');">ดูรายการสั่งซื้อสินค้า</a></li>
            <?php if ($row_order['DWNFLAG']=="N") { ?>
                       <?php if ($dist=="0999") { ?>                
                               <li><a href="#" onclick="javascript:confirmEdit('<? echo $script_link ; ?>','<?  echo $p_no; ?>');" >เพิ่มเติม/แก้ไขรายการสั่งซื้อ </a></li>                                           
                      <?php }  ?> 
                             
                     <?php if ($dist  <> "0999") { ?>
                              <li><a href="#" onclick="javascript:confirmEdit('<? echo $script_link ; ?>','<?  echo $p_no; ?>');" >เพิ่มเติม/แก้ไขรายการสั่งซื้อ </a></li>    
                              <!--  <li><a href="#" onclick="javascript:confirmEdit('order_form.php?doMode=Edit&amp;<? echo $script_link ; ?>','<?  echo $p_no; ?>');" >เพิ่มเติม/แก้ไขรายการสั่งซื้อ </a></li> -->           
                       <?php }  ?> 
