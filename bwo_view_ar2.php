				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Tahoma, Geneva, sans-serif; font-size:13px;">
						  <tr>
							<td width="700" colspan="2" align="center">
							  ...
							  <tr>
								<td width="479" colspan="2" align="left"><strong>คะแนนสะสม พอยท์ รีวอร์ด ของสมาชิกที่มีอยู่ตอนนี้ คือ :</strong><font color="#FF0000">
								<?php echo $point; ?></font> คะแนน</td>
							  </tr>
							  <tr>
								<td width="479" colspan="2" align="left"><strong>เงินปันผลของสมาชิกที่มีอยู่ตอนนี้คือ  :  </strong><?php echo $award; ?></td>
							  </tr>
							  <tr>
						...
						<table border="1" cellpadding="0" cellspacing="0"width="650"> 
						  <tr align=center>
							<td colspan="6">รางวัลสะสมคะแนนเบทเตอร์เวย์พอยท์รีวอร์ด</td>
						  </tr>
						  <tr bgcolor=#FBEFF8 align=center>
							...
							<th>คะแนนสะสมที่จะหมดอายุ ภายในรอบจำหน่ายที่ 26/2015</th>
						  </tr>
						  <tr align=center>
