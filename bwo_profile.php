...
//echo $url_webservice;
$ws_client = new soapclient($url_webservice.'bwc_order_history.php?wsdl',true); 
      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="871" border="0" cellspacing="0" cellpadding="0" >
          <tr>
              ...
              <tr>
                <td width="151" align="right" valign="top">รหัสสมาชิก :<br />
                  ชื่อสมาชิก : </td>
...
?>
              ...
              <tr>
                ...
                <td align="left"><input type="button" name="button2" id="button2" value="Reset"  onclick="clear_vlaue();"  class="formbutton"/>
                  <input type="button" name="Button" id="button" value="View"  onclick="javascript:document.getElementById('curpage').value=''; form_submit();" <?php if ($maintenance=="yes"){ echo " disabled='disabled'"; } ?>  class="formbutton" />
