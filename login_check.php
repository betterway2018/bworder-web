	...
	///////////////////  GET Paramete  MSLMST_ETL//////////////////////////////////////
		  ...
		  $query_= " SELECT
			...
			//echo    $query_;	 exit;
					 ...
					 $APPT_STATUS = $row_mslmst_01['APPT_STATUS'];
					...
					//echo $YUPIN_STATUS; exit;
					 ...
					 $valuetemp = "1";
					  if($STATUS_ETL == 'NM' ) //กรณีสถานะ Remove สามารถเข้ามาสั่งซื่้อได้ เเต่กรณ๊ ถอนสภาพหรือ DEL ไม่สามารถเข้าได้
						{
                           if($APPT_STATUS == 'DE')
						   {
							 $status = 'Inactive';  
							$sqlGOLDCLUB=" UPDATE MSLMST SET GOLDCLUB  = '$GOLDCLUB_ETL',STATUS  = 'Inactive'  WHERE   rep_seq=".$rep_seq; 
						   ...
						   else
						   {
							...
							$status = 'Active';  
							$sqlGOLDCLUB=" UPDATE MSLMST SET GOLDCLUB  = '$GOLDCLUB_ETL',STATUS  = 'Active'  WHERE   rep_seq=".$rep_seq; 							
							   
						   }
						
						
					//	echo $sqlGOLDCLUB; exit;
