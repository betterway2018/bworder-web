    ...
    <td height="480" align="left" valign="top" class="Sheet_Boder" style="padding:2px"><h3>
      ...
      <table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td colspan="2" align="center"  bgcolor="#daf2e3"><a href="<? echo $faris[2]."/".$html_default  ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe', width: 1100,height:800})"></a><a href="<? echo $mistine[2]."/".$html_default ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe', width: 1100,height:800})"></a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="5"><a href="http://www.friday.co.th/Catalogue/catalogue_friday.asp?camp=201110">faris camp 201110</a></td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
        </tr>
