...
$query="Select * From content_data  Where group_id=6  and status = 0 Order by  id desc";
...
if (isset($_GET['id']) && $_GET['id'] !="") {
		mysql_select_db($database_bwc_content, $bwc_content);
		$query_content_data = "SELECT * FROM content_data WHERE group_id=6 and  id=".$_GET['id'];
		...
		mysql_select_db($database_bwc_content, $bwc_content);
		$query_content_data = "SELECT * FROM content_data WHERE  group_id =6  and is_default ='Y'";
		$content_default = mysql_query($query_content_data, $bwc_content) or die(mysql_error());
		$row_content_default = mysql_fetch_assoc($content_default);
		$totalRows_content_default = mysql_num_rows($content_default);
		if ($totalRows_content_default==0) {
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <td align="center" valign="top" bgcolor="#FFFFFF" style="padding:3px;height:300px"><table width="783" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="17%"><img src="table_smooth/demo_faris.png" width="300" height="78" /></td>
  ...
  <br />
    ...
    <table width="872" border="0" cellspacing="0" cellpadding="4">
      <tr>
        <td colspan="2" align="left">&nbsp;ใบปลิวหน้าอื่น จาก ฟาริส</td>
        </tr>
      <tr>
...
<?php 
	...
	do {
?>        
         <li><a href="news_vfarisdemo.php?id=<?php echo $row_content_data['ID'];?>" target="_parent"><?php echo $row_content_data['SUBJECT'];?></a></li> 
<?php 
	$i++;
