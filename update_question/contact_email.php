...
//$totalRows_webboard = mysql_num_rows($webboard);
		...
		//--$totalRows_webboard = mysql_num_rows($webboard);
				...
				echo  " <fieldset>";
				echo  " <font color=#ff8899> ID MEMBER  </font> " .  $row_content_data['msl_code']."<br>";
				//echo " <font color=#ff8899> วันที่ลงทะเบียน  </font> " . $datefrom . " to " . $dateto . "<br>";
				echo " <font color=#ff8899> EMAIL MEMBER   </font> " . $row_content_data['EMAIL'] . "<br>"; 
				echo " <font color=#ff8899>  ROW_INDEX : </font> " . $row_index . "<br>"; 
				echo "</fieldset>";
				echo "<br>";
...
<?php 
 ...
 $message = "<strong>ส่งเมล์ตอบคำถาม (Answer by Email</strong>)";
 $tis620 = iconv("utf-8", "windows-874", $message );
 
  $messagere2 = "reply";
 $messagereshow = iconv("utf-8", "windows-874", $messagere2 );
 
?>
<body>
<div align="center"><?php  echo $tis620; ?></div>

<script type="text/javascript" src="https://bworder.com/update_question/ckeditor/ckeditor.js"></script>
<br>
<center>
<a href="https://cookies.ningnongmistine.com/bworder_img/index.php"
 target="_blank" style="color:#FFA500"> <?php echo iconv("utf-8", "windows-874", "เพิ่มลิ้งรูปภาพ" ); ?>  </a> &nbsp;&nbsp;&nbsp;
 
<a href="https://cookies.ningnongmistine.com/bworder_img/index.php" target="_blank" style="color:#33CC00"> 
 <?php echo iconv("utf-8", "windows-874", "วิธีเพิ่มภาพในการตอบเมล" ); ?>  </a>   </center>

<form  id="form1" name="form1" method="post" action="https://bworder.com/Administrator/contact_email_update.php">
<input name="hidROW_INDEX" type="hidden" id="hidROW_INDEX" value="<?php echo  $row_content_data['ROW_INDEX']; ?>" size="5">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="2">
    ...
    <tr>
      ...
      <td bgcolor="#FFF9FC">
        <input name="txtSubject" type="text" id="txtSubject" value="<?php echo  $messagereshow.": " . $row_content_data['SUBJECT']; ?>" size="48"></td>
    </tr>
    <tr>
      <td align="right" valign="top" bgcolor="#FFF9FC"><strong><?php  echo iconv("utf-8", "windows-874", 'ชื่อ' ); ?></strong></td><td bgcolor="#FFF9FC"><input name="txtTo2" type="text" id="txtTo2" value="<?php  echo  $row_content_data['NAME']; ?>" size="48" readonly="readonly"></td>
    </tr>
    <tr>
      <td align="right" valign="top" bgcolor="#FFF9FC"><p><strong><?php  echo iconv("utf-8", "windows-874", 'รหัส' ); ?> :</strong></p></td>
    ...
    <tr>
      <td align="right" valign="top" bgcolor="#FFF9FC"><strong> <?php  echo iconv("utf-8", "windows-874", 'กลุ่มคำถาม' ); ?>  </strong></td>
      <td bgcolor="#FFF9FC"><span class="ProductBottomLine">
        <input name="txtGROUP_ID" type="text" id="txtGROUP_ID" value="<?php  echo $row_content_data['GROUP_ID']; ?>" size="25" readonly="readonly">
        <textarea name="txtDetail" cols="88" rows="1" id="txtDetail" style="visibility:hidden"><?php  echo iconv("utf-8", "windows-874", 'รายละเอียด' )." : " . $row_content_data['DETAIL']; ?>
        </textarea>
      </span></td>
    </tr>
    <tr>
      <td align="right" valign="top" bgcolor="#FFF9FC"><strong> <?php echo iconv("utf-8", "windows-874", 'ถาม' );?>  :</strong></td>
    ...
    <tr>
      <td align="right" valign="top" bgcolor="#FFF9FC"><strong> <?php echo iconv("utf-8", "windows-874", 'ตอบ' );?> :</strong></td>
      <td bgcolor="#FFF9FC">
