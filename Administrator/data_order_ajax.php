...
FROM
	order_header WHERE order_header.DELFLAG in ('N','Y') ";
...
?>  
  <tr  bgcolor="<?php  echo $bg; ?>" nowrap>
    <td><a href="javascript: MM_openBrWindow('Admin_order_view.php?<?php echo $script_link; ?>','', 760, 550);"><img src="images/xmag.png" width="16" height="16" border="0"></a></td>
