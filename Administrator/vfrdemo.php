...
<title>BWC INTERNET ORDER SYSTEM : <?php  echo $_SESSION['login_name'];?></title>
...
<br />
<font color="#3366FF">
<h2>Update Demo : FRIDAY ON WWW.BWORDER.COM</h2></font>
...
?>
  <tr style="height:25px">
    ...
    <td height="16" align="center" valign="top" bgcolor="#F1F3F5">
      <a href="#" onclick="MM_openBrWindow('../vfrdemo_preview.php?id=<? echo $row_data['ID']?>','preview_news',800,600,'no')"> View </a> | <a href="../vfrdemo_form_FCKeditor.php?Mode=Update&id=<?php echo $row_data['ID'];?>">Edit</a>  | <a href="#" 
      onclick="confirmDelete('vfrdemo_delete.php?message_id=<? echo $row_data['ID'];?>');">*Delete DEMO FRIDAY*</a></td>
  </tr>
  <?php
}
  ?>
...
<br /><center>
<input type="button" name="button" id="button" value="Create DEMO FRIDAY"  onclick="window.location='../vfrdemo_form_FCKeditor.php?Mode=Insert'"/>
</center>
<br />
</body>
</html>