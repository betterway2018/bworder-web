 ...
 if ($oldindex != $newindex) { 
   ...
   <tr  bgcolor="<?php  echo $bg;?>" nowrap  style="color:<? echo $f_color;?>;font-weight:<? echo $f_w;?>" valign="top">
    ...
    <tr valign="top">
      ...
      <td>&nbsp;</td>
      <td><?php  if ($row_webboard['ROW_INDEX']<=123533 and $row_webboard['ROW_INDEX']>=123484) { echo utf8_to_tis620($row_webboard['NAME']); } else { echo $row_webboard['NAME']; } ?></td>
    </tr>
    <tr>
    ...
    <td align="left" valign="top"><p><font color="#CC0066" size="-1">หัวข้อ</font><br />
      <?php  if ($row_webboard['ROW_INDEX']<=123533 and $row_webboard['ROW_INDEX']>=123484) { echo utf8_to_tis620($row_webboard['SUBJECT']); } else { echo  $row_webboard['SUBJECT']; } ?>
      <br />
      <font color="#CC0066" size="-1"><br />
        </font><?php if ($row_webboard['ROW_INDEX']<=123533 and $row_webboard['ROW_INDEX']>=123484) { echo utf8_to_tis620($row_webboard['DETAIL']); } else { echo $row_webboard['DETAIL']; } ?></p>
