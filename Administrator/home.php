...
<title>BWC ORDERS :Administrator (สำหรับผู้ดูแลระบบเท่านั้น) <?php  echo $_SESSION['login_name'];?></title>
...
Update Banner บนหน้า DEMO+PLUSPLAN</a></td>
...
ลบคำถามและปัญหาผ่านเมลล์ (Contact us) </a></td>
<?
}
?>
  </tr>
...
ข้อมูลสมาชิก mslmst (ยังไม่ได้)</a></td>
...
ข่าวประชาสัมพันธ์</a></td>
   ...
   <tr>
    <td height="76" align="center"><a href="Summary_webbord.php" target="mainFrame"><img src="images/sum.png" width="103" height="103" border="0" /><br />
      สรุปจำนวนเเยกตามหมวดหมู่จากกระทู้
    </a></td>
</tr>
</table>
<br />
