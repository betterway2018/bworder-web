...
if($dist == "0999")
{
        ...
        $totalRows_order = mysql_num_rows($order);
         ...
         mysql_select_db($database_bwc_orders, $bwc_orders);
        $query_order_line = "SELECT * FROM order_detail  WHERE dist='$dist' and mslno='$mslno' and chkdgt='$chkdgt'   and ordcamp='$camp' order by  ListNO";
...
{ 
        ...
        $query_order = " SELECT *  FROM order_header WHERE dist='$dist' and mslno='$mslno' and chkdgt='$chkdgt'  and ordcamp='$camp' ";
        $order = mysql_query($query_order, $bwc_orders) or die(mysql_error());
	    // echo $query_order; exit;
        $row_order = mysql_fetch_assoc($order);
        $totalRows_order = mysql_num_rows($order);
         ...
         mysql_select_db($database_bwc_orders, $bwc_orders);
        $query_order_line = "SELECT * FROM order_detail  WHERE dist='$dist' and mslno='$mslno' and chkdgt='$chkdgt' and ordcamp='$camp' and ORDER_NO ='$po' order by  ListNO";
	//	echo "data1".$query_order_line; 
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><br /><center>
      <img src="../image_head/product_list.gif" width="274" height="31" /></center>
    <hr />
