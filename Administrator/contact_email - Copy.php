...
<script type="text/javascript" src="https://bworder.com/Administrator/ckeditor/ckeditor.js"></script>
<br>
...
<input name="hidROW_INDEX" type="hidden" id="hidROW_INDEX" value="<?php echo  $row_content_data['ROW_INDEX']; ?>" size="5">
 ...
 <textarea cols="80" id="editor1" name="editor1"  class="ckeditor" rows="25">
