...
<body>
<br/>
<font color="#006633"><h3>&nbsp;&nbsp;&nbsp;Update News from BW</h3></font>
...
?>
  <tr style="height:25px">
    ...
    <td height="16" align="center" valign="top" bgcolor="#F1F3F5">
      <a href="#" onclick="MM_openBrWindow('../news_preview.php?id=<? echo $row_data['ID']?>','preview_news',800,600,'no')"> View </a> | <a href="../news_form_FCKeditor.php?Mode=Update&id=<?php echo $row_data['ID'];?>">Edit</a>  | <a href="#" 
      onclick="confirmDelete('news_delete.php?message_id=<? echo $row_data['ID'];?>');">Delete</a></td>
  </tr>
  <?php
}
  ?>
...
<br /><center>
<input type="button" name="button" id="button" value="Create News &amp; Event"  onclick="window.location='../news_form_FCKeditor.php?Mode=Insert'"/>
</center>
<br />
</body>
</html>