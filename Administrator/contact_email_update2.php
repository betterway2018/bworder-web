...
//echo "email";	
	...
	$strMessage = "รหัสสมาชิก ". $_POST['txtCode'] . "<br>".  $_POST['txtDetail'] . "<br>" . "คำตอบ : " . nl2br($_POST['txtAnswer']) . "<br>" ."ตอบโดย: ". $_POST['txtAnswerBy'] . "<br>อีเมล์ฉบับนี้ตอบกับเพียงครั้งเดียวเท่านั้น หากท่านต้องการสอบถามข้อมูลเพิ่มเติม กรุณาติดต่อ Call center <br> 
โทรฟรี ! ทั่วประเทศ สำหรับผู้ใช้บริการ เอไอเอสและวันทูคอล<br>
กดรหัสพิเศษ *7479000 หรือโทร.0-2548-1555 (เสียค่าโทร) <br>
วันจันทร์-ศุกร์ เวลา 8.00-24.00 น. วันเสาร์-อาทิตย์ เวลา 8.00-17.30 น. " ;
	...
	//echo "ผู้ส่งเมลล์" . $strHeader . "<br><br>ส่งเมลล์ให้  ". $strTo . "<br><br>หัวข้อ  ". $strSubject . "<br><br>ข้อความ.. " . $strMessage;
