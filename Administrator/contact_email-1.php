...
$query = "SELECT A.ROW_INDEX, concat(lpad(dist,3,'0'),'-',lpad(mslno,5,'0'),'-',lpad(chkdgt,1,'0')) msl_code, NAME, GROUP_ID, SUBJECT, DETAIL, A.IP, CREATE_DATE, CREATE_TIME,CHK_MAIL, EMAIL, PHONE, ANSWER ANSWER_COUNT, B.ROW_INDEX ANSWER_INDEX, B.ANSWER_DETAIL
...
<input name="hidROW_INDEX" type="hidden" id="hidROW_INDEX" value="<?php echo  $row_content_data['ROW_INDEX']; ?>" size="5">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="2">
    ...
    <tr>
      ...
      <td bgcolor="#FFF9FC"><textarea name="txtAnswer" cols="88" rows="10" id="txtAnswer"></textarea></td>
    </tr>
    <tr>
