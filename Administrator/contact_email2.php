...
<br>
<form  id="form1" name="form1" method="post" action="contact_email_update2.php">
<input name="hidROW_INDEX" type="hidden" id="hidROW_INDEX" value="<?php echo  $row_content_data['ROW_INDEX']; ?>" size="5">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="2">
      ...
      <td bgcolor="#FFF9FC"><input name="txtFrom" type="text" id="txtFrom" value="callcenter_answer@bworder.com" size="48"></td>
    </tr>
    <tr>
