    ...
    <td width="99%" align="left" valign="top" bgcolor="#F3D8E6"><table border="0" align="center" cellpadding="1" cellspacing="0">
      ...
      <tr>
        <td align="left"><fieldset>
          <form action="promotion_copy_update.asp" method="post" name="form1" id="form1" >
            <table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr class="table_head2">
                <td align="center">Copy to Campaign</td>
              </tr>
              <tr>
                <td align="left" valign="top" bgcolor="#FFDDEE"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                  <tr class="FormBorder_CFCFCF">
                    <td colspan="3" align="left" ><table width="325" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                          <td width="106" align="right">จากรอบจำหน่าย :</td>
                          <td width="219"><input name="txtcamp1" type="text" disabled="disabled" id="txtcamp1" value="<%=MID(rsH("Camp"),5,2)%>" size="2" maxlength="2" />
/
  <input name="txtyear1" type="text" disabled="disabled" id="txtyear1" value="<%=MID(rsH("Camp"),1,4)%>" size="4" maxlength="4" />
  <input name="txtCamp" type="hidden" id="txtCamp" value="<%=rsH("Camp") %>" /></td>
                        </tr>
                        <tr>
                          <td align="right">ไปรอบจำหน่าย :</td>
                          <td><input name="txtcamp2" type="text" id="txtcamp2" size="2" maxlength="2" />
/
  <input name="txtyear2" type="text" id="txtyear2" size="4" maxlength="4" /></td>
                        </tr>
                        <tr>
			...
			%>
                  <tr>
                    ...
                    <td align="left"><input name="<%="txtid" &cstr(i)%>" type="text" disabled="disabled" id="<%="txtid" &cstr(i)%>" value="<%=billCode%>" size="10" maxlength="5" /></td>
                    <td align="left"><input name="<%="txtname" &cstr(i)%>" type="text" disabled="disabled" id="<%="txtname" &cstr(i)%>" value="<%=billDesc%>" size="70" maxlength="90" /></td>
                    <td><input name="<%="txtprice"&cstr(i)%>" type="text" disabled="disabled" id="<%="txtprice"&cstr(i)%>" value="<%=billPrice%>" size="10" maxlength="10" /></td>
                  </tr>
                  <%
            ...
            <center>
              ...
              <input type="submit" name="Submit" id="Submit" value="Copy to Campaign" />
            </center>
