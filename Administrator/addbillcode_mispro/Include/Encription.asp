<%
	Const  sBASE_64_CHARACTERS = "0123456789+/abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"	



 Function decode(ByVal asContents)
	Dim lsResult
	Dim lnPosition
...
Function encode(ByVal asContents)
	Dim lnPosition
	Dim lsResult
	Dim Char1
	Dim Char2
