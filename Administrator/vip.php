...
<h2><font color="#9933FF">Update NEWS AND EVENT ON WWW.BWORDER.COM</font></h2>
...
?>
  <tr style="height:25px">
    ...
    <td height="16" align="center" valign="top" bgcolor="#F1F3F5">
      <a href="#" onclick="MM_openBrWindow('../vip_preview.php?id=<? echo $row_data['ID']?>','preview_news',800,600,'no')"> View </a> | <a href="../vip_form_FCKeditor.php?Mode=Update&id=<?php echo $row_data['ID'];?>">Edit</a>  | <a href="#" 
      onclick="confirmDelete('vip_delete.php?message_id=<? echo $row_data['ID'];?>');">*Delete DEMO FRIDAY*</a></td>
  </tr>
  <?php
}
  ?>
...
<br /><center>
<input type="button" name="button" id="button" value="Create DEMO NEWS AND EVENT"  onclick="window.location='../vip_form_FCKeditor.php?Mode=Insert'"/>
</center>
<br />
</body>
</html>