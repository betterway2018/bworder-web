...
<br />
<font color="#339999">
<h2>Update Demo : FARIS ON WWW.BWORDER.COM</h2></font>
...
?>
  <tr style="height:25px">
    ...
    <td height="16" align="center" valign="top" bgcolor="#F1F3F5">
      <a href="#" onclick="MM_openBrWindow('../vfarisdemo_preview.php?id=<? echo $row_data['ID']?>','preview_news',800,600,'no')"> View </a> | <a href="../vfarisdemo_form_FCKeditor.php?Mode=Update&id=<?php echo $row_data['ID'];?>">Edit</a>  | <a href="#" 
      onclick="confirmDelete('vfarisdemo_delete.php?message_id=<? echo $row_data['ID'];?>');">*Delete DEMO FARIS*</a></td>
  </tr>
  <?php
}
  ?>
...
<br /><center>
<input type="button" name="button" id="button" value="Create DEMO FARIS"  onclick="window.location='../vfarisdemo_form_FCKeditor.php?Mode=Insert'"/>
</center>
<br />
</body>
</html>