<body onLoad="MM_preloadImages('images/images/c02.gif','images/images/g02.gif','images/images/i02.gif')">

<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-image:url(images/h_bg.gif);background-position:top;background-repeat:repeat-x;height:150px">
  ...
  <tr>
    <td height="23" colspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr valign="top" bgcolor="#FFDFEF">
        <td colspan="3" align="center" valign="middle"><?php require("i_title.php"); ?></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td colspan="4" align="center" valign="top" style="padding:2px"><a href="index.php" target="_parent">
...
<?php
 if ($_SESSION['login']==1) {
	// echo "121212";
	printf("<font color = #27408B size =3><b>ยินดีต้อนรับคุณ %s   รหัสสมาชิก %s-%s-%s </b></font>",$_SESSION['name'],$_SESSION['dist'],$_SESSION['mslno'],$_SESSION['chkdgt'] ); 
	printf("<br><font color = #FF3E96 size =3><b>เข้าสู่ระบบสั่งซื้อสินค้าที่สะดวกสบาย ของเบทเตอร์เวย์ ตลอด 24 ชม.</b></font>") ;
  } 
  ?>
</a></td>
  </tr>
...
if ( strpos($_SERVER['REQUEST_URI'],"login.php")==false &&  strpos($_SERVER['REQUEST_URI'],"index.php")==false && $_SESSION['login']==1)  {
							?>
  <tr>
    <td  colspan="4" align="left" valign="top" style="padding:2px"><br>      <?php //require("i_menu.php"); ?></td>
  </tr>
<?php } ?>  
